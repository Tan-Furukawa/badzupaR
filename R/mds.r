...
#' getBootstrapMDS
#'
#' @param datList A number
#' @param ci, hoge
#' @param Nbootstrap hoge
#' @examples
#' print("test")
#' 
...
#' plotBootstrapMDS
#'
#' @param resBootstrapMDS A number
#' @param addPoints, hoge
#' @examples
#' print("test")
...
# })
# 
 datList <- IsoplotR::examples$DZ[c(1,1,2)]
 res <- getBootstrapMDS(datList, Nbootstrap = 100, watcher = function(progress, total) print(progress))
 res$ellipseCoordinate
 # (res$bootstrapCoordinate)
# 
# 
# <- names(datList)
